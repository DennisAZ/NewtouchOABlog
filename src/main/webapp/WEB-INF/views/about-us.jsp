	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				...
				<a href="https://github.com/DennisAZ/NewtouchOA"
					class="btn btn-primary" target="_blank">获取源码</a>
			</div>
		</div>
	</div>
	<!--/.container--> </section>
		...
		<div class="about-us">
			<div class="row">
				...
				<div class="col-md-4 col-sm-6">
					<h3>我们的历史</h3>
					<p>
						<strong>1994年6月4日</strong><br>
						上海新致软件股份有限公司于1994年6月4日在上海市工商局登记成立，公司经营范围包括计算机软件开发、设计和制作，销售自产产品等
					</p>
					<p>
						<strong>2014-2017</strong><br> 参与集团电信MSS项目，并获得用户好评
					</p>
					<p>
						<strong>2015</strong><br> 开始在全国部署数据分析项目，并参与开发财务相关数据分析项目建设.
					</p>
				</div>
				<!--/.col-md-4-->
			</div>
				...
				<div class="row testimonials">
					<div class="col-sm-4">
						<blockquote>
							...
							<span class="clients-name">- 电信行业某客户</span> <img
								class="img-circle img-thumbnail"
								src="${pageContext.request.contextPath}/images/testimonials/man1.jpg">
						</blockquote>
					</div>
					<div class="col-sm-4">
						<blockquote>
							<p class="clients-words">软件是一个企业的软实力，新致公司所提供的软件简单实用，将复杂的问题简单化，易操作，安全性高.</p>
							<span class="clients-name">- 医疗行业某客户</span> <img
								class="img-circle img-thumbnail"
								src="${pageContext.request.contextPath}/images/testimonials/woman1.jpg">
						</blockquote>
					</div>
					<div class="col-sm-4">
						<blockquote>
							<p class="clients-words">新致公司完美的展现了"软件是门艺术"这句话，用实际行动告诉我们客户是上帝的软件开发思维模式</p>
							<span class="clients-name">- 金融行业某客户</span> <img
								class="img-circle img-thumbnail"
								src="${pageContext.request.contextPath}/images/testimonials/man1.jpg">
						</blockquote>
					</div>
