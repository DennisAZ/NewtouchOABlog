...
<body>
	...
	<div class="container">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.html"><i class="fa fa-bolt"></i>
				NewtouchOA</a></a>
		</div>
			...
			<div class="features">
				<div class="col-md-4 col-sm-6">
					<div class="feature-wrap">
						...
						<h2>
							<a
								href="${pageContext.request.contextPath}/downloadFile/fileDownLoad?file=lfwd.docx">开发文档</a>
						</h2>
				...
				<div class="col-md-4 col-sm-6">
					<div class="feature-wrap">
						...
						<h2>
							<a
								href="${pageContext.request.contextPath}/downloadFile/fileDownLoad?file=bswd.docx">部署建议</a>
						</h2>
						<h3>项目部署方式.</h3>
					</div>
				</div>
				...
				<div class="col-md-4 col-sm-6">
					<div class="feature-wrap">
						...
						<h2>
							<a
								href="${pageContext.request.contextPath}/downloadFile/fileDownLoad?file=Web_OAXQGL.doc">需求文档</a>
						</h2>
						<h3>需要开发功能的需求文档展示.</h3>
					</div>
				</div>
				...
				<div class="col-md-4 col-sm-6">
					<div class="feature-wrap">
						...
						<h2>
							<a
								href="${pageContext.request.contextPath}/downloadFile/fileDownLoad?file=ccsc.doc">操作手册</a>
						</h2>
