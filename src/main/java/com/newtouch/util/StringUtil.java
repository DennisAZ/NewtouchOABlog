...
//		return s;
    ...
    * @Date: 2015-6-17
    ...
    /**
     * @Title: isNumberOrEnLetter
     * @Description: 判断是否是数字或者大写字母
     * @param value
     * @return
     * @Author: lit
     * @Date: 2016-2-2
      */
     public static boolean isNumberOrEnLetter(String value)
     {
     ...
     public static String rtrim(String s,String c) {
     	...
     	if(tempStr.startsWith(c)){
     		tempStr = rtrim(s.substring(c.length()),c);
     	}
     	return tempStr;
     }
     ...
     public static String ltrim(String s,String c) {
     	...
     	if(tempStr.endsWith(c)){
     		tempStr=ltrim(s.substring(0, s.length()-c.length()),c);
     	}
     	return tempStr;
     }
      ...
      * 
     * @Title: getRandomNUM
     * @Description: 获取指定长度的随机数字串
     * @param length
     * @return
     * @createdBy:liuliu
     * @createaAt:2016-12-2下午11:11:10
      */
