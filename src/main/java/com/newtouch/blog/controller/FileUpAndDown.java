...
public class FileUpAndDown {
    ...
    public ResponseEntity<byte[]> fileDownLoad(HttpServletRequest request,@RequestParam(value = "file") String file) throws Exception{
      ServletContext servletContext = request.getSession().getServletContext();
      String fileName=file;
      String realPath = servletContext.getRealPath("/doc/"+fileName);//得到文件所在位置
