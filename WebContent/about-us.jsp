    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse navbar-right">
        <ul class="nav navbar-nav">
          ...
          <li class="active"><a href="about-us.jsp">源代码</a></li>
        ...
        <div class="row testimonials">
          <div class="col-sm-4">
            <blockquote>
              ...
              <span class="clients-name">- 电信行业某客户</span> <img class="img-circle img-thumbnail" src="images/testimonials/man1.jpg"> </blockquote>
          </div>
          <div class="col-sm-4">
            <blockquote>
              <p class="clients-words">软件是一个企业的软实力，新致公司所提供的软件简单实用，将复杂的问题简单化，易操作，安全性高.</p>
              <span class="clients-name">- 医疗行业某客户</span> <img class="img-circle img-thumbnail" src="images/testimonials/woman1.jpg"> </blockquote>
          </div>
          <div class="col-sm-4">
            <blockquote>
              <p  class="clients-words">新致公司完美的展现了"软件是门艺术"这句话，用实际行动告诉我们客户是上帝的软件开发思维模式</p>
              <span class="clients-name">- 金融行业某客户</span> <img class="img-circle img-thumbnail" src="images/testimonials/man1.jpg"> </blockquote>
          </div>
        </div>
        <!--/.row--> 
      </div>
