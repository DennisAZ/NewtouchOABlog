    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse navbar-right">
        <ul class="nav navbar-nav">
          ...
          <li class="active"><a href="portfolio.jsp">产品</a></li>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="portfolio-items">
        ...
        <div class="portfolio-item apps col-xs-12 col-sm-4 col-md-4">
          <div class="recent-work-wrap"> <img class="img-responsive" src="images/portfolio/full/item8.jpg" alt="">
            <div class="overlay">
              <div class="recent-work-inner">
                <h3><a href="#">今日日程</a></h3>
        ...
        <div class="portfolio-item apps col-xs-12 col-sm-4 col-md-4">
          <div class="recent-work-wrap"> <img class="img-responsive" src="images/portfolio/full/item9.jpg" alt="">
            <div class="overlay">
              <div class="recent-work-inner">
                <h3><a href="#">待办中心</a></h3>
        ...
        <div class="portfolio-item apps col-xs-12 col-sm-4 col-md-4">
          <div class="recent-work-wrap"> <img class="img-responsive" src="images/portfolio/recent/item10.jpg" alt="">
            <div class="overlay">
              <div class="recent-work-inner">
                <h3><a href="#">审批查看</a></h3>
                <p>可以查看待我审批、经我审批信息。.</p>
                <a class="preview" href="images/portfolio/full/item10.jpg" rel="prettyPhoto"><i class="fa fa-search"></i> View</a> </div>
            </div>
          </div>
        </div>
        
        <div class="portfolio-item apps col-xs-12 col-sm-4 col-md-4">
          <div class="recent-work-wrap"> <img class="img-responsive" src="images/portfolio/recent/item11.jpg" alt="">
            <div class="overlay">
              <div class="recent-work-inner">
                <h3><a href="#">文档中心</a></h3>
                <p>可以按划分的实际目录查看文档中心及个人文件柜上传的文档信息，并可在线阅读文档的内容。</p>
                <a class="preview" href="images/portfolio/full/item11.jpg" rel="prettyPhoto"><i class="fa fa-search"></i> View</a> </div>
            </div>
          </div>
        </div>
        
        <div class="portfolio-item apps col-xs-12 col-sm-4 col-md-4">
          <div class="recent-work-wrap"> <img class="img-responsive" src="images/portfolio/recent/item12.jpg" alt="">
            <div class="overlay">
              <div class="recent-work-inner">
                <h3><a href="#">通讯录</a></h3>
                <p>可以查看系统的公司、公共、个人通讯录，并且可以查看通讯录中任一人员的详细信息，并且可以自动识别电话号码进行打电话、发送手机短信功能（需手机支持）.</p>
                <a class="preview" href="images/portfolio/full/item12.jpg" rel="prettyPhoto"><i class="fa fa-search"></i> View</a> </div>
            </div>
          </div>
        </div>
        <!--/.portfolio-item--> 
